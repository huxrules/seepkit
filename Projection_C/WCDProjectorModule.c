...
static PyObject * cWCDProjector(PyObject *self, PyObject *args){
	...
	if (ASA == NULL)
	{
		printf("malfunction ASA is null");
	}
...
static PyMethodDef AstrosMethods[] = {
	{"WCDProjector", cWCDProjector, METH_VARARGS},
	{NULL,NULL}
};

static struct PyModuleDef projectormodule = {
...
PyMODINIT_FUNC PyInit_HLProjector(void)
{
	return PyModule_Create(&projectormodule);
}